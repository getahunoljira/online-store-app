...
class PaymentServiceTest {
  ...
  void successfulCreditCardPayment() {
    ...
    IPaymentService svc = new com.online.shop.service.payment.PaymentServiceImpl(repo, new MockGatewayClient());
  ...
  void invalidAmountRaises() {
    IPaymentService svc = new com.online.shop.service.payment.PaymentServiceImpl(mock(PaymentRepository.class), new MockGatewayClient());
    CreditCardPaymentStrategy strategy = new CreditCardPaymentStrategy("4111111111111111");
    assertThatThrownBy(
            () ->
                svc.processPayment(
