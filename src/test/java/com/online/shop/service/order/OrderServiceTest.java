...
class OrderServiceTest {
  ...
  void createOrderSuccess() {
    ...
    IOrderService svc = new com.online.shop.service.order.OrderServiceImpl(mockRepo, mockInv, java.util.List.of());
  ...
  void createOrderEmptyCartThrows() {
    IOrderService svc = new com.online.shop.service.order.OrderServiceImpl(mock(OrderRepository.class), mock(IInventoryService.class), java.util.List.of());
  ...
  void shipOrder() {
    ...
    IOrderService svc = new com.online.shop.service.order.OrderServiceImpl(mockRepo, mock(IInventoryService.class), java.util.List.of());
